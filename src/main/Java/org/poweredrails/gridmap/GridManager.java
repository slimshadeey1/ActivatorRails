...
public class GridManager
    implements Iterable<Object>, Serializable, Comparable<GridManager>, GridMap {
    ...
    @Override public void createLayer(int l) {
        if (l != 0) {
    ...
    @Override public void createGrid(int l, Object a, Object b, Object object) {
    ...
    @Override public Object getGridObject(int l, Object a, Object b) {
        if (!new GridKey(a, b).equals(null) || l != 0) {
            if (GridManager.layer.containsKey(l) && GridManager.grid
                .containsKey(new GridKey(a, b))) {
    ...
    @Override public int compareTo(GridManager arg0) {
    ...
    @Override public <X> GridMap fromArray(X[] array) {
        // TODO Auto-generated method stub
        return null;
    }

    @Override public <X> GridMap fromCollection(Collection<X> collection) {
        // TODO Auto-generated method stub
        return null;
    }
